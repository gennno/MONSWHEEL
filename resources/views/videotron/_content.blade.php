...
@php
    function actualCellClass($field, $last)
    {
        ...
        return $field === $last ? 'bg-green-600 text-white font-bold ring-2 ring-green-400' : 'bg-green-600/20';
    }
@endphp
<div class="p-4 space-y-4">
    ...
    <!-- TABLE CONTAINER -->
    <div class="overflow-hidden  border border-gray-700 bg-gray-950">
        <table id="serviceTable" class="w-full border-collapse table-fixed">
            ...
            <tbody class="text-sm font-semibold">
                @forelse ($services as $service)
                    ...
                    <tr class="border-b border-gray-900 even:bg-gray-800">
                        ...
                        <td class="px-4 py-4 text-center border-r border-gray-700">
                            ...
                            @if ($status)
                                <span
                                    class="status-badge px-1 py-1 rounded-full font-semibold uppercase
             {{ $map[$status] ?? 'bg-gray-500/20 text-gray-300' }}">
                        ...
                        <td
                            class="px-2 py-3 text-center  border-r border-gray-700
                        ...
                        <!-- Action Service -->
                        <td class="px-2 py-3 text-center ">{{ $service->action_service_plan?->format('H:i') ?? '-' }}
                        </td>
                        <td
                            class="px-2 py-3 text-center  border-r border-gray-700
                        ...
                        <!-- Action Backlog -->
                        <td class="px-2 py-3 text-center ">{{ $service->action_backlog_plan?->format('H:i') ?? '-' }}
                        </td>
                        <td
                            class="px-2 py-3 text-center  border-r border-gray-700
